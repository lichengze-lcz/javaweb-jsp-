 ...
 body{background: #f3f9f1}
  ...
  <div class="form-group">
   ...
   <div class="form-group">
    ...
    <input type="text" name="adress" class="form-control" id="exampleInputName4">
  </div>
  <div class="form-group">
    <label for="exampleInputEmail2">邮箱</label>
    <input type="email" name="emall" class="form-control" id="exampleInputEmail2">
  </div>
...
<c:forEach items="${pb.list}" var="user" varStatus="s">
       ...
       <tr bgcolor="#84AF9B">  <!-- @@@@@@@@***javascript提交表单  提交选中框       传递id参数  传递到servlet-->
         ...
         <td>
                 <!--操作按钮 传递当前行id值-->
          <a class="btn btn-default btn-sm" href="${pageContext.request.contextPath}/FindUserByPageServlet?id=${user.id}">修改</a>
  ...
  <ul class="pagination">
    ...
    <!--按钮激活功能    如果是当前页active-->
       <c:if test="${pb.currentPage == i}">                                     <!--传递参数 当前页码 每行显示的数？  -->
